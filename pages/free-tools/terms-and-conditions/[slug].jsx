...
const TermsAndConditions = (props) => {
  const finalWebsiteName = props.data.data.websiteName;
  const finalWebsiteUrl = props.data.data.websiteUrl;
  return (
    <>
      <div style={{ backgroundColor: "#1d1d24", width: "100%" }}>
        <h2 style={{ fontSize: "40px" }} className="theme-gradient my-5 mx-4">
          {"Terms and Conditions for " + finalWebsiteName}
        </h2>
      </div>
      <div className="container my-5">
        ...
        <p>
          ...
          use of {finalWebsiteName}'s Website, located at {finalWebsiteUrl}.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use {finalWebsiteName} if you do not
        ...
        <p>
          We employ the use of cookies. By accessing {finalWebsiteName}, you
          agreed to use cookies in agreement with the {finalWebsiteName}'s
          Privacy Policy.{" "}
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, {finalWebsiteName} and/or its licensors own
          the intellectual property rights for all material on
          {finalWebsiteName}. All intellectual property rights are reserved. You
          may access this from {finalWebsiteName} for your own personal use
          subjected to restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from {finalWebsiteName}</li>
          <li>Sell, rent or sub-license material from {finalWebsiteName}</li>
          <li>Reproduce, duplicate or copy material from {finalWebsiteName}</li>

          <li>Redistribute content from {finalWebsiteName}</li>
        </ul>
        <p>
        ...
        <p>
          ...
          {finalWebsiteName} does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of {finalWebsiteName},its agents and/or affiliates.
          ...
          {finalWebsiteName} shall not be liable for the Comments or for any
        ...
        <p>
          {finalWebsiteName} reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant {finalWebsiteName} a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of {finalWebsiteName}; and (d)
        ...
        <p>
          ...
          sending an e-mail to {finalWebsiteName}. Please include your name,
        ...
        <p>
          No use of {finalWebsiteName}'s logo or other artwork will be allowed
...
export async function getServerSideProps(context) {
  ...
  const res = await fetch(
    "http://localhost:3000/api/terms-and-conditions/get",
    {
      method: "POST",
