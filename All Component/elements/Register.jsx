                    ...
                    <div className='col-xl-4 col-lg-6 col-md-6 col-sm-12' style={{ border: "1px solid white", boxShadow: "5px 10px 5px #888888", borderRadius: "0px 20px 20px 0px" }}>
                        <div className="p-3">
                            ...
                            <form>
                                ...
                                <button className='btn btn-primary mt-4 mb-4' style={{ width: "full", padding: "8px 24px" }}>Sign Up</button><br></br>
                                <span class="text-xs text-gray-500"><Link href="/login" prefetch={false} ><a>Already have account? SignIn</a></Link></span>
                            </form>
                        </div>
                    </div>
